...
- [ ] T2 Update `skills/planlet-plan/references/planning-guidance.md` for discovery stance (prefer about 2–4 related decisions per batch) and small independently verifiable tasks, preserving all skill-contract-pinned verification phrases and forbidden-command constraints
