...
- [x] T6 Document changelog upkeep and source-checkout fallback in `README.md`, and point release guidance at this planlet
...
- [ ] T18 Document publication gates and common tag-triggered release flow in `README.md`, and point `AGENTS.md` to the owner documents without duplicating release procedure

## Verification Evidence

- 2026-07-31 — Full-history audit found no unresolved credentials, personal-data, binary or large-object, or licensing/provenance findings; captain sign-off preceded the visibility decision.
