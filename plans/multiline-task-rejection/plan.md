...
- Document grammar in `planlet_design.md` section 10.4 and `skills/planlet-plan/assets/tasks-template.md`, update `README.md` if it describes task syntax (it does not today), plus a `CHANGELOG.md` `[Unreleased]` entry for this user-visible validation change.
...
- Grammar is documented in `planlet_design.md` section 10.4 and `skills/planlet-plan/assets/tasks-template.md` (update `README.md` if it describes task syntax, it does not today), and `CHANGELOG.md` `[Unreleased]` records the user-visible validation change.
