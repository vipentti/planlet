...
- The default TOON output keeps data and diagnostics separated and uses documented error and exit-code behavior; `--json`, `--human`, and `--quiet` are explicitly deferred to a later phase.
